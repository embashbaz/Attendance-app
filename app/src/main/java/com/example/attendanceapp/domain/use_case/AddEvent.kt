...
{
    suspend operator fun invoke(eventType: String, eventName: String, eventDescription: String): Flow<OperationStatus<String>> {
        ...
        val newEvent = Event(0, eventType, eventName, "", eventDescription)
