...
@HiltViewModel
class CheckAttendanceViewModel @Inject constructor(private val getAttendance: GetAttendance, val validateGetAllParticipantParameters: ValidateGetAllParticipantParameters) : ViewModel(){
